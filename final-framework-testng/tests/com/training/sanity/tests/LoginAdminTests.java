...
public class LoginAdminTests {
	...
	private LoginAdminPOM loginPOM;
	private HomeAdminPOM homePOM;
	...
	public void setUp() throws Exception {
		...
		loginPOM = new LoginAdminPOM(driver); 
		homePOM = new HomeAdminPOM(driver);
	...
	public void validLoginTest() throws InterruptedException {
		...
		loginPOM.savebutton();
		screenShot.captureScreenShot("Admin");
	}
}
